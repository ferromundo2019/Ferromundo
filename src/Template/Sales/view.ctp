...
<li><?= $this->Html->link(__('List Sale Details'), ['controller' => 'SaleDetails', 'action' => 'index']) ?> </li>
<li><?= $this->Html->link(__('New Sale Detail'), ['controller' => 'SaleDetails', 'action' => 'add']) ?> </li>
<li><?= $this->Html->link(__('Export to PDF'), ['action' => 'view', $sale->id, '_ext' => 'pdf']); ?></li>
</ul>
<?php
$this->end();
?>
<div class="panel panel-default">
    ...
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><?= __('Sold') ?></td>
            <td><?= $sale->sold ? __('Yes') : __('No').' '.$this->Form->postLink('', ['action' => 'sold', $sale->id], ['confirm' => __('Are you sure to sell # {0}? This action is irreversible' , $sale->id), 'title' => __('Sell'), 'class' => 'btn btn-default glyphicon glyphicon-piggy-bank']); ?></td>
        </tr>
    </table>
</div>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($sale->sale_details)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($detallesVenta as $details): ?>
                <tr>
                    <td><?= h($details['id']) ?></td>
                    ...
                    <td class="actions">
                        <?= $this->Html->link('', ['controller' => 'SaleDetails', 'action' => 'view', $details['id']], ['title' => __('View'), 'class' => 'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['controller' => 'SaleDetails', 'action' => 'edit', $details['id']], ['title' => __('Edit'), 'class' => 'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['controller' => 'SaleDetails', 'action' => 'delete', $details['id']], ['confirm' => __('Are you sure you want to delete # {0}?', $details['id']), 'title' => __('Delete'), 'class' => 'btn btn-default glyphicon glyphicon-trash']) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
